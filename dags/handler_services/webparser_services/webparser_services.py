...
class BykeDataPage:
    ...
    def get_all_links_files_data(self) -> list[DataBikeUrlsClass]:
        ...
        links_2 = [DataBikeUrlsClass.from_tuple_link_file_name(link_file[0], link_file[1]) for link_file in links]
        print(links_2)
        return links_2